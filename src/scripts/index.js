...
const checkTextBefore = () => {
   if (textBefore.value !== '') {
      return textBefore.innerHTML = 'Original'
   }
...
const checkTextAfter = () => {
   if (textAfter.value !== '') {
      return textAfter.innerHTML = 'After'
   }
   return
}
...
const handleCombine = () => {
   if (plainText.value === '') {
      ...
      return alert('Plaintext is still empty!');
   } else if (key.value === '') {
      chipertext.innerHTML = '';
      return alert('Key is still empty!');
   } else if (coverImage.value === '') {
      return alert('Cover Image is still empty!');
   } else if (chipertext.value === '') {
      return alert('Ciphertext is still empty!');
   }
...
const handleDecrypt = () => {
   if (stegoImage.value === '') return alert('Please upload the Steganography image!');
   if (keyDecrypt.value === '') return alert('Please fill in the password field!');
